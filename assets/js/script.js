(function ($) {
    ...
    window.addEventListener('scroll', function () {
        ...
        parallaxScroll();
        parallaxHeroScroll(); // jika kamu punya efek lain
    });
    ...
    // Tambahkan wobble saat elemen dalam viewport
    function parallaxHeroScroll() {
        const image = document.getElementById('parallaxImage');
        if (!image) return;
...
-------------------------------------------*/
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2025-6-14 08:00:00', function (event) {
    ...
    if ($("#clock-resepsi").length) {
        $('#clock-resepsi').countdown('2025-6-14 08:00:00', function (event) {
            var $this = $(this).html(event.strftime(''
                + '<div class="box"><div><div class="time">%D</div> <span>Days</span> </div></div>'
                + '<div class="box"><div><div class="time">%H</div> <span>Hours</span> </div></div>'
                + '<div class="box"><div><div class="time">%M</div> <span>Mins</span> </div></div>'
